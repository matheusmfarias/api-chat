                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:0 20px">
                                                                    ...
                                                                    <p style="color:#1f58a2;font-size:18px">
                                                                        Você está recebendo esse e-mail pois solicitou a alteração do e-mail da sua conta.<br><br>
                                                                        Confirme a alteração de e-mail usando o código abaixo.
                                                                    </p>
                                                                    <h2
                                                                        style="color:#1f58a2; font-size: 24px; text-align: center; margin: 20px 0;">
                                                                        ${token}
                                                                    </h2>
                                                                </td>
                                                            </tr>
